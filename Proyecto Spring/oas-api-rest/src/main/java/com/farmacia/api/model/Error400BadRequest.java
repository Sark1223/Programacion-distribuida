...
@Schema(name = "Error400BadRequest", description = "Error 400 - Solicitud incorrecta")
...
public class Error400BadRequest implements Serializable {
   ...
   */
  public Error400BadRequest(String code, String message) {
    this.code = code;
    this.message = message;
  }

  public Error400BadRequest code(String code) {
    this.code = code;
    return this;
  }
  ...
  */
  ...
  public Error400BadRequest details(Map<String, Object> details) {
    this.details = details;
    return this;
  }

  public Error400BadRequest putDetailsItem(String key, Object detailsItem) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.code, error400BadRequest.code) &&
